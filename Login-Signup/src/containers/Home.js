...
export default class Home extends Component {
  ...
  handleSubmit = event => {
    ...
    if (!date.isValid()) {
      ...
      const url = "http://149.165.171.47:30025/getAirport?origin="+this.state.origin+"&destination="+this.state.destination+"&date="+this.state.date+"&search_id="+this.state.search_id;
      console.log("url", url);
      fetch(url, {
        method: "GET",
        headers: {
